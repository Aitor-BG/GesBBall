...
class MenuEquipo: AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.menuequipo)
        ...
        //Marcamos como opción el equipo local, y deshabilitamos el poder elegir otros como locales (1-12) o visitantes (13-24)
        ...
        //Buscamos los resultados del partido seleccionado
        btconf.setOnClickListener{
            val sharedPreferences: SharedPreferences = getSharedPreferences("PartidoVer", MODE_PRIVATE)
            val editor : SharedPreferences.Editor = sharedPreferences.edit()
            editor.putString("partidover",local+" - "+visitante)
            editor.apply()
            Toast.makeText(applicationContext, "Partido: ${local} - ${visitante}", Toast.LENGTH_SHORT).show()
            val intent = Intent(this@MenuEquipo, Equipo::class.java)
            startActivity(intent)
        }

        //Volvemos a la pestaña anterior -> Menu
